                                ...
                                <form role="form" action ="docs/Service/choice.php" method="POST">
                                    <div class="box-body">
                                        <div class="form-group" style="width:465px">
                                            ...
                                            <input type="text" class="form-control" name="area" id="tags" placeholder="Start typing your area, eg. Marathahalli">
                                        </div>
                                        ...
                                        <select class="form-control" id="mark" name="company" onchange="bikelist(this.value)">
                                     ...
                                     <label>Bike Model<span class="error" id="bikename">*</span></label>
                                        ...
                                        <div class="form_elem" style="width:465px">
                                            ...
                                            <p id="datepairExample">
                                                <input type="text" style="float:left;width:265px;padding-left:20px;text-align:center" class="date start form-control" name="date_" placeholder="eg.:27/07/2014"/>

    ...
    if(isset($_POST['submit'])){ 
     ...
     if($_POST['servicetype']=='Periodic Servicing' or $_POST['servicetype']=='Waterwash Service' or $_POST['servicetype']=='Insurance Renewal'){
        ...
        }elseif($_POST['servicetype']=='Puncture'){

...
<head>
    ...
    <link rel="stylesheet" href="../../styles/css/jQueryUI/jquery-ui.css"></head>
<body class="skin-blue">
    <!-- header logo: style can be found in header.less -->
    <header class="header">
        <a href="http://rishihero.heromotocorpdealers.com/HMC/Default.aspx/" target="_blank" class="logo">
            <!-- Add the class icon to your logo image or logo icon to add the margining -->Rishi Motors</a>
    ...
    <div class="box">
        ...
        <form role="form" action ="vendor_index.php" method="POST">
            <div class="box-body">
                ...
                <select id="opt_tab" name="place"></select>
...
while ($rw1 = mysql_fetch_array($query_result2)) {
    $setopt=$setopt."
<option value='".$rw1['area']."'>".$rw1['area']."</option>
";
    if(distance($src['lati'],$src['longi'],$rw1['lati'],$rw1['longi'])
<$dist and $src['area']!=$rw1['area']){
...
print "
<script>document.getElementById('det_tab').innerHTML='$O_row'+document.getElementById('det_tab').innerHTML;</script>
";
print "
<script>document.getElementById('opt_tab').innerHTML=\"".$setopt."\";</script>
";
?>
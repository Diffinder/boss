...
<!--changed-->                        <li>Dashboard</li>
                           ...
                           <select class="form-control" id="status_upd"  name="orderID" style="width:30%;text-align: center;
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div style="float:right;"> <h3 class="box-title" >Rate the Service :</h3><div id="serRating" type="number" class="rating" style="float:right;margin:10px 5px 0px 10px;"></div></div>
                                </div><!-- /.box-header -->
        ...
        <!-- Bootstrap -->
        <script src="../../script/js/plugins/bootstrap.min.js" type="text/javascript"></script>
        <!-- DATA TABES SCRIPT -->
        <!-- AdminLTE App -->

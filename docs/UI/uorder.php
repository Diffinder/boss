                                ...
                                <div class="col-md-12">
                                    <div class="form-group" style="">
                                        <label style="">Appointment Date&nbsp;<span class="error" id="adt">*</span></label>
                                         <p id="datepairExample">   <input id="" type="text" onchange="checkfield();" style="" class="date start form-control half-width" id="date_" name="date_" placeholder="eg.:27/07/2014"/>
                                    </div>
                                </div>                                      

                                <div class="box-footer ">
                                        <button type="submit" name="submit" class="btn btn-primary" style="margin-left:5px">Submit Query</button>
                                    </div>
                                    </div><!-- /.box-body -->
